...
import com.bendrisstarek.rabobankassessment.util.CollectionUtils;
 ...
 * @param <V>
 */
public class BaseAdapter<D, V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<V> {
